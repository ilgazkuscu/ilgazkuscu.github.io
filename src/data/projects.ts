...
export const projects: Project[] = [
  {
    ...
    tagline:
      "Inspectable prediction-market intelligence built from public evidence and market data.",
    context:
      "Fast-moving markets compress many competing explanations into one price. SignalOS preserves the evidence trail behind its own changing belief.",
    built: [
  ...
  },
  {
    ...
    tagline:
      "Notebook-based Higgs-boson analysis using public ATLAS collision data.",
    context:
      "ATLAS Open Data makes real particle-physics analysis reproducible outside the experiment, but event selection and data handling still require careful validation.",
    built: [
  ...
  },
  {
    ...
    context:
      "US Accidents dataset is large, highly imbalanced, and full of leakage traps.",
    built: [
  ...
  },
  {
    ...
    tagline:
      "End-to-end EDA, PCA, and interactive visualization on highway accident data.",
  ...
  },
  {
    ...
    context:
      "I needed to track time across five course sections without the bloat of existing tools.",
    built: [
  ...
  },
  {
    ...
    tagline:
      "Real-time dashboard surfacing large trades on Polymarket geopolitical markets.",
    context:
      "An earlier iteration of the SignalOS thesis, a standalone dashboard before the broader platform.",
    built: [
  ...
  },
  {
    ...
    tagline:
      "A three-indicator ARIMA/ARIMAX baseline for quarterly U.S. GDP growth.",
    context:
      "GDP is reported with a lag, so timely indicators can provide an earlier baseline read.",
    built: [
      "Compared naive, ARIMA, and ARIMAX forecasts.",
      "Used industrial production, retail sales, and initial unemployment claims from FRED.",
      "Prepared a tested local repository while documenting the absence of historical data vintages.",
    ],
    stack: ["Python", "statsmodels", "pandas"],
    metrics: [
      { value: "3", label: "macroeconomic indicators" },
  ...
  },
  {
    ...
    context:
      "Markets shift between regimes; detection enables adaptive strategies.",
    built: [
  ...
  },
  {
    ...
    context:
      "Cross-metro housing data is fragmented; consolidated analysis reveals patterns.",
    built: [
